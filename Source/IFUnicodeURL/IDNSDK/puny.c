...
static int is_all_basic(DWORD input_length, const DWORD input[])
{
  int j;
...
static int punycode_encode( unsigned int input_length,
                     const DWORD input[],
...
static int punycode_decode( unsigned int input_length,
                     const char input[],
                     unsigned int *output_length,
                     DWORD output[] )
{
